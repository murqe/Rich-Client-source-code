...
import zxc.rich.client.features.combat.HitBox;
...
public abstract class Entity implements ICommandSender {
    ...
    public void func_191958_b(float p_191958_1_, float p_191958_2_, float p_191958_3_, float p_191958_4_) {
        ...
        if (f >= 1.0E-4F) {
            ...
            if(Main.instance.featureDirector.getFeature(KillAura.class).isEnabled() && KillAura.target != null && this instanceof EntityPlayerSP && KillAura.silentMove.getBoolValue() && Minecraft.getMinecraft().player.getDistanceToEntity(KillAura.target) > 1.5) {
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        if (Main.instance.featureDirector.getFeature(NoPush.class).isEnabled() && NoPush.blocks.getBoolValue()) {
            return false;
        } else {
    ...
    public float getCollisionBorderSize() {
        if (Main.instance.featureDirector.getFeature(HitBox.class).isEnabled()) {
