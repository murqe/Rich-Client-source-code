...
public abstract class EntityLivingBase extends Entity {
    ...
    private int getArmSwingAnimationEnd() {
        if (Main.instance.featureDirector.getFeature(SwingAnimations.class).isEnabled()) {
    ...
    public Vec3d getLook(float partialTicks) {
        if (!Main.instance.featureDirector.getFeature(KillAura.class).isEnabled() && this instanceof net.minecraft.client.entity.EntityPlayerSP)
    ...
    public boolean canBePushed() {
        if (Main.instance.featureDirector.getFeature(NoPush.class).isEnabled() && NoPush.players.getBoolValue()) {
            return false;
        }
