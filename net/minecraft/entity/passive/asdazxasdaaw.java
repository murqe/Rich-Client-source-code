...
public class asdazxasdaaw extends EntityAnimal
{
    private static final DataParameter<Integer> RABBIT_TYPE = EntityDataManager.<Integer>createKey(asdazxasdaaw.class, DataSerializers.VARINT);
    ...
    public asdazxasdaaw(World worldIn)
    {
        super(worldIn);
        this.setSize(0.4F, 0.5F);
        this.jumpHelper = new asdazxasdaaw.RabbitJumpHelper(this);
        this.moveHelper = new asdazxasdaaw.RabbitMoveHelper(this);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(1, new asdazxasdaaw.AIPanic(this, 2.2D));
        ...
        this.tasks.addTask(4, new asdazxasdaaw.AIAvoidEntity(this, EntityPlayer.class, 8.0F, 2.2D, 2.2D));
        this.tasks.addTask(4, new asdazxasdaaw.AIAvoidEntity(this, EntityWolf.class, 10.0F, 2.2D, 2.2D));
        this.tasks.addTask(4, new asdazxasdaaw.AIAvoidEntity(this, EntityMob.class, 4.0F, 2.2D, 2.2D));
        this.tasks.addTask(5, new asdazxasdaaw.AIRaidFarm(this));
    ...
    public void updateAITasks()
    {
        ...
        if (this.onGround)
        {
            ...
            asdazxasdaaw.RabbitJumpHelper entityrabbit$rabbitjumphelper = (asdazxasdaaw.RabbitJumpHelper)this.jumpHelper;
    ...
    {
        ((asdazxasdaaw.RabbitJumpHelper)this.jumpHelper).setCanJump(true);
    }

    private void disableJumpControl()
    {
        ((asdazxasdaaw.RabbitJumpHelper)this.jumpHelper).setCanJump(false);
    }
    ...
    {
        EntityLiving.registerFixesMob(fixer, asdazxasdaaw.class);
    }
    ...
    public asdazxasdaaw createChild(EntityAgeable ageable)
    {
        asdazxasdaaw entityrabbit = new asdazxasdaaw(this.world);
        int i = this.getRandomRabbitType();

        if (this.rand.nextInt(20) != 0)
        {
            if (ageable instanceof asdazxasdaaw && this.rand.nextBoolean())
            {
                i = ((asdazxasdaaw)ageable).getRabbitType();
            }
            else
            {
    ...
    public void setRabbitType(int rabbitTypeId)
    {
        if (rabbitTypeId == 99)
        {
            ...
            this.tasks.addTask(4, new asdazxasdaaw.AIEvilAttack(this));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (livingdata instanceof asdazxasdaaw.RabbitTypeData)
        {
            i = ((asdazxasdaaw.RabbitTypeData)livingdata).typeData;
            flag = true;
        }
        else
        {
            livingdata = new asdazxasdaaw.RabbitTypeData(i);
        }
    ...
    /**
     * Returns true if {@link asdazxasdaaw#carrotTicks carrotTicks} has reached zero
     */
    ...
    {
        private final asdazxasdaaw entityInstance;

        public AIAvoidEntity(asdazxasdaaw rabbit, Class<T> p_i46403_2_, float p_i46403_3_, double p_i46403_4_, double p_i46403_6_)
        {
    ...
    {
        public AIEvilAttack(asdazxasdaaw rabbit)
        {
    ...
    {
        private final asdazxasdaaw theEntity;

        public AIPanic(asdazxasdaaw rabbit, double speedIn)
        {
    ...
    {
        private final asdazxasdaaw rabbit;
        private boolean wantsToRaid;
        private boolean canRaid;

        public AIRaidFarm(asdazxasdaaw rabbitIn)
        {
    ...
    public class RabbitJumpHelper extends EntityJumpHelper
    {
        ...
        public RabbitJumpHelper(asdazxasdaaw rabbit)
        {
            super(rabbit);
            this.theEntity = rabbit;
        }
    ...
    static class RabbitMoveHelper extends EntityMoveHelper
    {
        ...
        public RabbitMoveHelper(asdazxasdaaw rabbit)
        {
            super(rabbit);
            this.theEntity = rabbit;
        }
        ...
        {
            if (this.theEntity.onGround && !this.theEntity.isJumping && !((asdazxasdaaw.RabbitJumpHelper)this.theEntity.jumpHelper).getIsJumping())
            {
