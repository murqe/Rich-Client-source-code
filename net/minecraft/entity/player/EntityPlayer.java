...
import zxc.rich.client.features.movement.Sprint;
...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public void onUpdate() {
        this.noClip = Main.instance.featureDirector.getFeature(FreeCam.class).isEnabled() || Main.instance.featureDirector.getFeature(NoClip.class).isEnabled() || this.isSpectator();
        if (this.isSpectator()) {
            this.onGround = false;
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            if (Main.instance.featureDirector.getFeature(Sprint.class).isEnabled() && Sprint.keepSprint.getBoolValue()) {
    ...
    public boolean isPushedByWater() {
        if (Main.instance.featureDirector.getFeature(NoPush.class).isEnabled() && NoPush.water.getBoolValue()) {
            return false;
        }
        return !this.capabilities.isFlying;
    }
