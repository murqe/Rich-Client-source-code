...
import zxc.rich.client.features.misc.FastWorldLoad;
import zxc.rich.client.ui.font.FontUtil;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    public MCFontRenderer mono14;
    public MCFontRenderer mono15;
    public MCFontRenderer mono16;
    public MCFontRenderer mono17;
    public MCFontRenderer mono18;
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.mono14 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mono.ttf"), 14.0f, 0), true, true);
        this.mono15 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mono.ttf"), 15.0f, 0), true, true);
        this.mono16 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mono.ttf"), 16.0f, 0), true, true);
        this.mono17 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mono.ttf"), 17.0f, 0), true, true);
        this.mono18 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/mono.ttf"), 18.0f, 0), true, true);
        this.robotoRegular = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/robotoregular.ttf"), 20.0f, 0), true, true);
        this.robotoRegular18 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/robotoregular.ttf"), 18.0f, 0), true, true);
        this.lato = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/lato.ttf"), 18.0f, 0), true, true);
        this.lato15 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/lato.ttf"), 15.0f, 0), true, true);
        ...
        this.urwgeometric = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/urwgeometric.ttf"), 18.0f, 0), true, true);
        this.tenacity = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("font/tenacity.ttf"), 18.0f, 0), true, true);
        ...
        Main.instance.client.connect("51.38.166.157", 9898);

        DataInputStream in = new DataInputStream(Main.instance.client.getSocket().getInputStream());
        DataOutputStream out = new DataOutputStream(Main.instance.client.getSocket().getOutputStream());
        ...
        this.displayGuiScreen(Main.instance.client.getScreen(AES.decrypt(in.readUTF(), "912389123")));
    ...
    public void freeMemory() {
        ...
        try {
            if (!Main.instance.featureDirector.getFeature(FastWorldLoad.class).isEnabled()) {
                System.gc();
                this.loadWorld(null);
            }
    ...
    public void shutdown() {
        EventShutdownClient eventShutdownClient = new EventShutdownClient();
        EventManager.call(eventShutdownClient);
        this.running = false;
    }
