...
import zxc.rich.api.event.types.EventType;
...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Event2D event = new Event2D(scaledresolution);
        ...
        if (scoreobjective1 != null) {
            ...
            EventManager.call(e);
            if(!(Main.instance.featureDirector.getFeature(zxc.rich.client.features.visuals.Scoreboard.class).isEnabled() && zxc.rich.client.features.visuals.Scoreboard.noScore.getBoolValue())) {
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        for (Score score1 : collection) {
            ...
            if (Main.instance.featureDirector.getFeature(NameProtect.class).isEnabled() && NameProtect.scoreboardSpoof.getBoolValue()) {
                this.getFontRenderer().drawString(s1.replace(Minecraft.getMinecraft().player.getName().substring(0, 2), "RichClient                                                                                                                                                                                                                                                                                                                                                                 "), l1, k, 553648127);
            } else {
