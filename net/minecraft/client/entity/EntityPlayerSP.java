...
import zxc.rich.client.features.movement.NoClip;
import zxc.rich.client.features.player.FreeCam;
import zxc.rich.client.features.player.NoPush;
import zxc.rich.client.features.player.NoSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        ...
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                if (!Main.instance.featureDirector.getFeature(FreeCam.class).isEnabled()) {
    ...
    private void onUpdateWalkingPlayer() {
        ...
        EventPlayerState event2 = new EventPlayerState(posX, posY, posZ, rotationYaw, rotationPitch, onGround);
        EventManager.call(event2);

        EventPreMotionUpdate eventPre = new EventPreMotionUpdate(rotationYaw, rotationPitch, posX, posY, posZ, onGround);
        EventManager.call(eventPre);
        ...
        EventPlayerState post = new EventPlayerState();
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        if (Main.instance.featureDirector.getFeature(NoPush.class).isEnabled() && NoPush.blocks.getBoolValue() || Main.instance.featureDirector.getFeature(FreeCam.class).isEnabled() || Main.instance.featureDirector.getFeature(NoClip.class).isEnabled())
            return false;
    ...
    public void onLivingUpdate() {
        ...
        if (this.isHandActive() && !this.isRiding()) {
            this.movementInput.moveStrafe *= Main.instance.featureDirector.getFeature(NoSlowDown.class).isEnabled() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
            this.movementInput.moveForward *= Main.instance.featureDirector.getFeature(NoSlowDown.class).isEnabled() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
