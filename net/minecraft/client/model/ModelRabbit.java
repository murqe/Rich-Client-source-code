...
import net.minecraft.entity.passive.asdazxasdaaw;
...
public class ModelRabbit extends ModelBase
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        asdazxasdaaw entityrabbit = (asdazxasdaaw)entityIn;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
    {
        ...
        this.jumpRotation = MathHelper.sin(((asdazxasdaaw)entitylivingbaseIn).setJumpCompletion(partialTickTime) * (float)Math.PI);
    }
}
