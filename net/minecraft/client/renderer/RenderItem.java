...
import zxc.rich.client.features.visuals.EnchantmentColor;
    ...
    private void renderEffect(IBakedModel p_191966_1_) {
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            ...
            if (!Config.isShaders() || !Shaders.isShadowPass) {
                ...
                if (Main.instance.featureDirector.getFeature(EnchantmentColor.class).isEnabled()) {
                    switch (EnchantmentColor.colorMode.currentMode) {
                        case "Rainbow":
                            this.func_191965_a(p_191966_1_, ColorUtils.rainbow((int) f, 1, 1).getRGB());
                            break;
                        case "Custom":
