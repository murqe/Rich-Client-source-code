...
import zxc.rich.client.features.visuals.Chams;
import zxc.rich.client.features.visuals.HitColor;
...
public abstract class RenderLivingBase<T extends EntityLivingBase> extends Render<T> {
    ...
    protected void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        boolean chamsCheck = (Main.instance.featureDirector.getFeature(Chams.class).isEnabled() && entitylivingbaseIn instanceof EntityPlayer);
        ...
        if (flag || flag1) {
            ...
            if (chamsCheck) {
                ...
                if (!Chams.clientColor.getBoolValue()) {
                    RenderUtils.setColor(Chams.colorChams.getColorValue());
                } else {
                    RenderUtils.setColor(ClientHelper.getClientColor().getRGB());
                }
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        if (!flag && !flag1) {
            ...
            if (flag1) {
                if (Main.instance.featureDirector.getFeature(HitColor.class).isEnabled()) {
