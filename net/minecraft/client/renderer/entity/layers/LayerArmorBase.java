...
import zxc.rich.client.features.visuals.CustomModel;
...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase>
{
    ...
    {
        if (Main.instance.featureDirector.getFeature(CustomModel.class).isEnabled() && entityLivingBaseIn instanceof EntityPlayerSP) {
            return;
        }
