...
import zxc.rich.client.features.visuals.SwingAnimations;
import zxc.rich.client.features.visuals.ViewModel;
...
public class ItemRenderer {
    ...
    private void transformEatFirstPerson(float p_187454_1_, EnumHandSide p_187454_2_, ItemStack p_187454_3_) {
        ...
        if (Main.instance.featureDirector.getFeature(ViewModel.class).isEnabled()) {
    ...
    private void transformFirstPerson(EnumHandSide p_187453_1_, float p_187453_2_) {
        ...
        if (Main.instance.featureDirector.getFeature(SwingAnimations.class).isEnabled() && SwingAnimations.item360.getBoolValue()) {
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.func_190926_b()) {
                ...
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                    ...
                    if (Main.instance.featureDirector.getFeature(SwingAnimations.class).isEnabled() && (this.mc.gameSettings.keyBindAttack.pressed && !SwingAnimations.auraOnly.getBoolValue() || Main.instance.featureDirector.getFeature(KillAura.class).isEnabled() && KillAura.target != null)) {
                        if (Main.instance.featureDirector.getFeature(SwingAnimations.class).isEnabled() && (this.mc.gameSettings.keyBindAttack.pressed && !SwingAnimations.auraOnly.getBoolValue() || Main.instance.featureDirector.getFeature(KillAura.class).isEnabled() && KillAura.target != null)) {
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (!this.mc.player.isSpectator()) {
            ...
            if (this.mc.player.isBurning() && !NoRender.noFire.getBoolValue() && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, this.mc.player, partialTicks)) {
