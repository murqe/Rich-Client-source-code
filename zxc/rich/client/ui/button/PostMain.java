...
public class PostMain
{
    public static void main(String[] p_main_0_)
    {
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("RichPremium" + Minecraft.getSystemTime() % 1000L);
