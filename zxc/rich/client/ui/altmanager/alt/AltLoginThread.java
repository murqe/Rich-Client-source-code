package zxc.rich.client.ui.altmanager.alt;
...
public class AltLoginThread extends Thread {
    ...
    public void run() {
        if (this.alt.getPassword().equals("")) {
            ...
            this.status = TextFormatting.GREEN +  "Logged in - " + ChatFormatting.RED + alt.getUsername()  + ChatFormatting.BOLD + " (non license)";
        } else {
