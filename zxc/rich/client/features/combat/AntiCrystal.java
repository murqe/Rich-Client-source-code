...
import zxc.rich.api.utils.world.BlockHelper;
...
public class AntiCrystal extends Feature {
    ...
    public AntiCrystal() {
        super("AntiCrystal", "јвтоматически ставит блок на обсидиан/бедрок", FeatureCategory.COMBAT);
    ...
    public void onPreMotion(EventPreMotionUpdate event) {
        ...
        if (InvenotryUtil.doesHotbarHaveBlock() && pos != null) {
